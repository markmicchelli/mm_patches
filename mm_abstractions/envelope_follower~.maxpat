...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.0, 267.0, 398.0, 33.0 ],
					"text" : "courtesy Chris Dobrian:\nhttps://music.arts.uci.edu/dobrian/maxcookbook/simple-envelope-follower"
				}
